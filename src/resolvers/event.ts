...
export const readActiveEventByType = (
  discordId: string,
  adjustedDate: string,
  type: GoalType
) => {
...
export const readActiveEventsByDateAndWeeklyGoalAndTimezone = (
  adjustedDate: string,
  goalIds: number[],
  timeZone: string
) => {
...
export const readAllEventsByDateAndTimezone = (
  adjustedDate: string,
  timeZone: string
) => {
  return Event.find({
...
export const updateEventToCompleted = (
  discordId: string,
  adjustedDate: string,
  type: GoalType
) => {
...
export const updateEventToInactive = (
  discordId: string,
  adjustedDate: string,
  type: GoalType
) => {
...
export const updateUserEventsToInactiveByType = (
  discordId: string,
  type: GoalType
) => {
...
export const updateEventGoalLeftChannelId = (
  discordId: string,
  adjustedDate: string,
